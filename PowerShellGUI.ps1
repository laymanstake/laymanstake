...
#New-ToastNotification -title "This is custom notification" -message "One liner custom message. Some extra long, super long `n Second line message " -logo "C:\temp\logo1.png" -heroImage "C:\temp\hero.png" -extraImage "C:\temp\extra.png"